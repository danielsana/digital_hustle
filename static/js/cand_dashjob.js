// $(document).ready(function(){
    // alert("hi")
    const perPage = 2;
    function cand_dash_jobs(currentPage, job_title, location, job_type, search_salary,tag){
        if(!currentPage) {
            currentPage = 1;
        }
        ...
        $.ajax({
            ...
            success: function(data){
                $('#cand_dash_jobs').html(data.htmlresponse);
    ...
    function fetch_jobs() {
        ...
        var currentPage = 1;
        // alert(job_type)
        cand_dash_jobs(currentPage, job_title, location, job_type, search_salary);
    }
...
function pages_jobs(page_no){
    ...
    var job_type = $('#search_category').val();
    var search_salary = $('#search_salary').val();
    cand_dash_jobs(page_no, job_title, location, job_type, search_salary);
}
...
function cat_tags(tagd) {
    ...
    // }
    currentPage -= 1;
    cand_dash_jobs(currentPage, job_title, location, job_type, search_salary, tagd);
}